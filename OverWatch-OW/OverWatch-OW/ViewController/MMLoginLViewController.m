...
@interface MMLoginLViewController ()<UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate>
...
@implementation MMLoginLViewController
...
- (void)initUI {
    ...
    HeadView * vc = [[HeadView alloc]initWithFrame:headRect backgroundView:@"loginBackground.jpg" headView:@"OW-bg.png" headViewWidth:(CGFloat)(VCWidth / 4) signLabel:@"在这里停顿"];
